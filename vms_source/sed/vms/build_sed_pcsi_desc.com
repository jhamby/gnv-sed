...
$!   Add file lines for sed.
$!   Add Link alias procedure file (used for sed)
$!   Add [.SYS$STARTUP]sed_startup file
$!   Add Release notes file.
$!
$! The file pcsi_sed_file_list.txt is read in to get the files other
...
$! Fortunately SED does not trip most of these issues, so those steps
...
$! link [usr.bin]sed. for [usr.bin]sed.exe.
$!
...
$!      1. Duplicate filenames need an alias procedure.
$!      2. ODS-5 filenames need an alias procedure.
$!      3. Special alias links for executables (sed. -> gnv$sed.exe)
$!         if a lot, then an alias procedure is needed.
$!      4. Rename the files to lowercase.
$!
$!
...
$!---------------------------------------------------------------------
$ open/read flst [.vms]pcsi_sed_file_list.txt
$!
$inst_alias_loop:
...
$! remove aliases
$   line_out = -
       "  ""@pcsi$destination:[gnv.vms_bin]sed_alias_setup.com remove"""
$   i = 0
$ex_rem_loop:
...
$       write pdsc line_out
$   endif
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]remove_old_sed.com"","
$   write pdsc line_out
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]sed_alias_setup.com"""
$   i = 0
$ex_pins_loop:
$       line = f$element(i, ",", add_alias_lines)
$       i = i + 1
...
$ write pdsc "     source [vms_bin]gnv$sed_startup.com ;"
$!
$!   Add Release notes file.
$!------------------------------
$ write pdsc -
