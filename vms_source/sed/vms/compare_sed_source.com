...
$!
$! By default:
$!    The source directory is source_root:[sed.reference.sed],
$!    the logical used on my system for the GNV Mecurial repository checkout.
$!    If source_root: is not defined, then src_root:[sed] will be
$!    translated to something like DISK:[dir.sed.reference.sed]
$!    and then DISK:[dir.sed.vms_source.sed] will be used.
$!
$!    The copy directory is vms_root:[sed]
...
$!     The source directory tree is: src_root:[sed]
$!     The copy directory is src_root1:[sed]
$!
$!   src_root1:[sed] is used by me to work around that VMS backup will
...
$!    The source directory is vms_root:[sed]
$!    The copy directory is vms_root1:[sed]
$!
$!   vms_root:
$!   src_root1:[sed] is used by me to work around that VMS backup will
$!   not use NFS as a source directory so I need to make a copy.
...
$   if update_file
$   then
$       if f$search("src_root1:[000000]sed.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed src_root1:[sed]
$       endif
$   endif
$endif
$!
...
$   if update_file
$   then
$       if f$search("vms_root1:[000000]sed.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed vms_root1:[sed]
$       endif
$   endif
$endif
$!
